...
namespace PaintIn3D
{
    ...
    public class P3dPaintableTexture : P3dLinkedBehaviour<P3dPaintableTexture>
    {
        ...
        [UnityEngine.Serialization.FormerlySerializedAs("channel")][SerializeField] private P3dCoord coord;
        ...
        public UndoRedoType UndoRedo { set { undoRedo = value; } get { return undoRedo; } }
        [UnityEngine.Serialization.FormerlySerializedAs("state")][SerializeField] private UndoRedoType undoRedo;
        ...
        [SerializeField] private int stateLimit = 10;
        ...
        [SerializeField] private SaveLoadType saveLoad;
        ...
        [SerializeField] private MipType mipMaps = MipType.Auto;

        /// <summary>The <b>filterMode</b> of the created texture.
        /// Auto = Copied from the <b>Texture</b>.</summary>
        public FilterType Filter { set { filter = value; } get { return filter; } }
        [SerializeField] private FilterType filter = FilterType.Auto;

        /// <summary>The <b>anisoLevel</b> of the created texture.
        /// Auto = Copied from the <b>Texture</b>.</summary>
        public AnisoType Aniso { set { aniso = value; } get { return aniso; } }
        [SerializeField] private AnisoType aniso = AnisoType.Auto;

        /// <summary>The <b>wrapModeU</b> mode of the created texture.
        /// Auto = Copied from the <b>Texture</b>.</summary>
        public WrapType WrapU { set { wrapU = value; } get { return wrapU; } }
        [SerializeField] private WrapType wrapU = WrapType.Auto;

        /// <summary>The wrapModeV of the created texture.
        /// Auto = Copied from the <b>Texture</b>.</summary>
        public WrapType WrapV { set { wrapV = value; } get { return wrapV; } }
        [SerializeField] private WrapType wrapV = WrapType.Auto;
        ...
        public ExistingType Existing { set { existing = value; } get { return existing; } }
        [SerializeField] private ExistingType existing = ExistingType.UseAndKeep;
        ...
        public ConversionType Conversion { set { conversion = value; } get { return conversion; } }
        [SerializeField] private ConversionType conversion;
        ...
        public Texture LocalMaskTexture { set { localMaskTexture = value; } get { return localMaskTexture; } }
        [SerializeField] private Texture localMaskTexture;

        /// <summary>This allows you to specify which channel from the <b>LocalMask</b> texture will be used.</summary>
        public P3dChannel LocalMaskChannel { set { localMaskChannel = value; } get { return localMaskChannel; } }
        [SerializeField] private P3dChannel localMaskChannel;
        ...
        public bool IsDummy { set { isDummy = value; } get { return isDummy; } }
        ...
        public string Output { set { output = value; } get { return output; } }
