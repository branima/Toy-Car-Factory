...
namespace PaintIn3D
{
    ...
    public class P3dPaintable : P3dModel
    {
        ...
        [SerializeField] private ActivationType activation = ActivationType.Start;
        ...
        public List<Renderer> OtherRenderers { set { otherRenderers = value; } get { return otherRenderers; } }
        ...
        public UnityEvent OnActivated { get { if (onActivated == null) onActivated = new UnityEvent(); return onActivated; } }
